...
<body class="bg-light">
    <table class="table table-striped table-bordered border-3 m-10 p-10">
        <tr class="font-bold p-4">
            <th class="p-4 border-3">ID</th>
            <th class="p-4 border-3">First Name</th>
            <th class="p-4 border-3">Last Name</th>
            <th class="p-4 border-3">Comments</th>
        </tr>
        @foreach ($students as $student)
            <tr class="p-4 border">
                <td class="p-4 border">{{ $student->id }}</td>
                <td class="p-4 border">{{ $student->first_name }}</td>
                <td class="p-4 border">{{ $student->last_name }}</td>
                <td>
                    <ol class="p-4">
                        @foreach ($student->comments as $comment)
                            <li class="p-2 border">{{ $comment->content }}</li>
                        @endforeach
                    </ol>
                </td>
            </tr>
